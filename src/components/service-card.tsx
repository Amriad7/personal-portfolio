...
export const CardIcon = ({ icon }: { icon: ReactNode }) => {
  return (
    <span className="size-12 sm:size-18 rounded-full text-center p-3 sm:p-5 bg-primary shadow-inner shadow-sky-200/50 absolute -top-6 sm:-top-9 left-1/2 -translate-x-1/2">
      {icon}
    </span>
  );
};
